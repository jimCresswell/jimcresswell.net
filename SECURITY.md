...
2. Use GitHub's private vulnerability reporting on this repository (Security tab → Report a vulnerability), or contact the owner through the address published on [jimcresswell.net](https://jimcresswell.net).
