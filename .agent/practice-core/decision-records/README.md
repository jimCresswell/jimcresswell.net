...
| [PDR-030](PDR-030-rendering-risk-needs-blocking-visual-proof.md)              | Rendering-Risk Changes Need Blocking Visual Proof                                  | Accepted |

PDR-026 through PDR-029 are reserved upstream for future drafting slots. The
gap between PDR-025 and PDR-030 is deliberate: this repo's local rendering-risk
PDR originally landed as PDR-025 on 2026-04-19 and was renumbered to PDR-030
the same day to clear the way for the upstream PDR-025 (Quality-Gate Dismissal
Discipline) and the reserved block PDR-026–029 without reusing a number or
overwriting a same-day local decision. See the renumbering note on PDR-030 and
the 2026-04-19 CHANGELOG entry for full context.
