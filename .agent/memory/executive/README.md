...
| [`collaboration-state-placement-contract.md`](collaboration-state-placement-contract.md) | Which substance-kind belongs in which file across the collaboration-state surface family | Authoring or auditing collaboration-state content placement |
| [`owner-signal-interpretation.md`](owner-signal-interpretation.md) | Channel semantics for owner direction — hedges, demonstrated actions, supersession vs extension, session-scoped defaults | Weighing whether an owner turn is a grant, a gate, a supersession, or thinking aloud; interpreting owner silence, reframes, or pauses |
...
| [`cross-platform-agent-surface-matrix.md`](cross-platform-agent-surface-matrix.md) | Platform-adapter support matrix across Cursor / Claude / Codex / Gemini / GitHub Copilot CLI | Verifying platform-adapter parity; adding a new platform |
