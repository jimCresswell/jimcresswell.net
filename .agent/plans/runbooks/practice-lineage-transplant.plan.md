...
- **Measured after the close (2026-09-15, the arc's retrospective).** Agent time, derived from
  the session transcripts after all: about sixty agent-active hours across four seats (10.3 in
  the lead seat to #53, about fifty for the closure; consecutive events at most ten minutes
  apart), 6,662 model calls and 8.35M output tokens. Card questions on 2026-09-14 were
