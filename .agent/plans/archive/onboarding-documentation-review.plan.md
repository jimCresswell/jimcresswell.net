...
2. Replace the entire section with:
   ...
   - [`.agent/directives/principles.md`](../../directives/principles.md) — Development rules: TDD, type safety, code quality
...
2. Links to `.agent/plans/component-audit.plan.md` which was moved to `.agent/plans/archive/component-audit.plan.md`.

**Steps:**

1. Read the full ADR-004.
2. Find the client component count. Change "2" to "3" and add `ThemeProvider` to the list.
3. Find the link to `component-audit.plan.md`. Update the path to `archive/component-audit.plan.md`.
4. Save the file.
...
2. From the Development Standards section, follow links to:
   ...
   - `.agent/directives/principles.md` — verify the quality gates list includes gitleaks.
