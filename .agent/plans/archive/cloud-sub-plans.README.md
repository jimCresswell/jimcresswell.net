...
- [`.agent/directives/AGENT.md`](../../directives/AGENT.md) — Project context and commands
- [`.agent/directives/principles.md`](../../directives/principles.md) — Core development rules (TDD, type safety, code quality)
- [`.agent/directives/testing-strategy.md`](../../directives/testing-strategy.md) — Testing philosophy and conventions
