...
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Architecture decision ambiguity or boundary concerns      | `architecture-expert` for the structure, plus the persona for the decision's lane (`.agent/sub-agents/components/architecture/reviewer-team.md`) |
