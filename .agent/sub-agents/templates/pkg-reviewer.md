...
| `.agent/plans/current/personal-knowledge-graph-source-of-truth-design.plan.md` | Current Track B design context when reviewing planning or architecture changes         |
