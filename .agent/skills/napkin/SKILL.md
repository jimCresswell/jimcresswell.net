...
logging. The distillation skill (`.agent/skills/distillation/SKILL.md`)
...
distillation skill (`.agent/skills/distillation/SKILL.md`)
to extract high-signal content into `distilled.md`, archive
the napkin, and start fresh.
