...
4. `.agent/directives/principles.md` and `.agent/directives/testing-strategy.md` — project conventions
...
6. **Create Zod schemas for entity validation**
   ...
   - The project's type-safety rules require external data validation (no `as`, no `any` — see `principles.md`)
