...
- **A4, A5 (`sif` instruments; the corpus workflow).** The node's ratified todo 1 governs:
  ...
  this estate carries. The restore landed on 2026-09-14 as row 3's own pull request, #86
  (the Director's slicing of the residue); the routing rewrite landed as row 5's, #87
