...
- **A1 residue (patterns).** Measured at item 4's review: live doctrine cites nine pattern
  ...
  Both land in the first of the two lane C pull requests that follow item 4 (not yet
  opened): the five files from the pin, scrubbed, with provenance lines, and the leg
  extended to resolve `patterns/<name>.md` against the patterns directory.
