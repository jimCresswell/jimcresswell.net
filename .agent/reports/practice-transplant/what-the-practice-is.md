...
- **A4, A5 (`sif` instruments; the corpus workflow).** The node's ratified todo 1 governs:
  ...
  this estate carries. They land in the two lane C pull requests that follow item 4, the
  restore first and the routing rewrite second (Director sequencing 2026-09-13; neither yet
  opened).
