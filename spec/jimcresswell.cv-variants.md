...
A **variant** is a *contextual view* of the CV, presented at a distinct URL:
...
- with *lightweight, explicitly-scoped adjustments* to emphasis and ordering so a reader in a specific context gets the most relevant story faster.
...
Variants are about *content emphasis*, not redesign.
