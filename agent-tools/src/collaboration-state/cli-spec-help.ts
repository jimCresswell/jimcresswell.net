...
export const commsListHelp =
  ...
  'author/display-prefix (the visual-disambiguator token — prefix + id ' +
  'tail; bare prefix for id-less blocks; display-only, never the ' +
  '--to-session-prefix value), [kind] (plus any [tags]), and title; --since keeps ' +
