...
export const ARC_METRICS_HELP_TEXT = [
  ...
  'calls, tokens counted once per call, median context per call, compactions,',
  'usage-limit stalls and owner messages (turns plus mid-turn messages).',
  '',
  'Options:',
  ...
  '  --gap-minutes <n>     Active-time threshold: consecutive events closer',
  '                        together than this count as active. Default 10.',
