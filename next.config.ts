 ...
 *
 * Static (no nonces) because the site is statically generated — nonces would
...
const cspDirectives = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ""} https://static.cloudflareinsights.com https://va.vercel-scripts.com`,
