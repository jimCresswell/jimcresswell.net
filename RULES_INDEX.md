...
matches the Cursor adapter realises as `globs`). Regenerate this file whenever
...
| `.agent/rules/no-skipped-tests.md`                                         | core           | —                                                                                                 |
...
| `.agent/rules/tsdoc-and-documentation-hygiene.md`                          | core           | —                                                                                                 |
