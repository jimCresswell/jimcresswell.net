...
- The Route Handler proxies ~195 KB of PDF binary per request (vs. a redirect which would offload the transfer to the Blob CDN). For a personal CV site with low traffic, this is negligible. CDN caching mitigates it further.
