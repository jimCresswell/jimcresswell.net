...
| Gemini                     | 20 `.gemini/commands/review-*.toml` + settings, `GEMINI.md`                                                                                                                                                                                                                                             | Carried (round 8); a generator output, the fourth platform of the adapter generator, authored by lane C after it lands |
